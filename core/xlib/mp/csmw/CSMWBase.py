...
class Control:
    """
    Base class of control element for Multi Workers
    
    unlike Single Worker, Multi workers cannot manage Controls by nature,
    thus all Controls and their content are static and predefined before start
    """
