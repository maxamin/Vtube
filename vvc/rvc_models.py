...
from vvc import modules
from vvc import attentions
from vvc import commons
from vvc.commons import init_weights, get_padding
...
class SynthesizerTrnMs256NSFsid(nn.Module):
    def __init__(self,
        ...
        resblock_kernel_sizes,resblock_dilation_sizes,upsample_rates,upsample_initial_channel,
        ...
        self.dec = GeneratorNSF(inter_channels,resblock,resblock_kernel_sizes,resblock_dilation_sizes,upsample_rates,
            upsample_initial_channel,upsample_kernel_sizes,gin_channels=gin_channels,sr=sr,is_half=kwargs["is_half"],)
