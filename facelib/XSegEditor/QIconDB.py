...
class QIconDB():
    ...
    def initialize(icon_path):
        ...
        QIconDB.open  = QIcon ( str(icon_path / 'folder-open.png') )
        QIconDB.landmark  = QIcon ( str(icon_path / 'from_landmark.png') )
        QIconDB.xseg_mask  = QIcon ( str(icon_path / 'xseg_mask.png') )
        QIconDB.clear  = QIcon ( str(icon_path / 'clear.png') )
        QIconDB.open  = QIcon ( str(icon_path / 'folder-open.png') )
        QIconDB.ok  = QIcon ( str(icon_path / 'ok.png') )
        QIconDB.save  = QIcon ( str(icon_path / 'save.png') )
        QIconDB.teeth  = QIcon ( str(icon_path / 'teeth.png') )
        QIconDB.eyes  = QIcon ( str(icon_path / 'eyes.png') )
        QIconDB.mouth  = QIcon ( str(icon_path / 'mouth.png') )
