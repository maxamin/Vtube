from core.localization import system_language
...
class QStringDB():
    ...
    def initialize():
        ...
        QStringDB.btn_open_dir_tip = {    'en' : 'Open Face Folder\n',
                                            'ru' : '--\n',
                                            'zh' : '打开人脸文件夹\n',
                                           }[lang]                               
        ...
        QStringDB.AutoConvertMaskText={'en' : 'AutoConvertMask',
                                 'ru' : '-',
                                 'zh' : '自动转换遮罩',
                                }[lang] 

        QStringDB.btn_from_landmark_tip={'en' : 'Create polygons from face landmark',
                                 'zh' : '从特征点提取人脸遮罩编辑多边形',
                                }[lang] 

        QStringDB.btn_from_xsegmask_tip={'en' : 'Create polygons from segmentation mask',
                                 'zh' : '从分割遮罩提取编辑多边形',
                                }[lang] 